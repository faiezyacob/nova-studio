            ...
            <div className="flex gap-3">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs leading-relaxed text-[#9f988c]">
                  It's not recommended to run Video Upscale simultaneously as this will cause RAM spike and system crash. Please release the memory first by clicking Clean All Memory.
                </p>
              </div>
            </div>
          </div>
