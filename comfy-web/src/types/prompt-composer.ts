...
export const CATEGORY_CONFIGS: CategoryConfig[] = [
  ...
  { key: "expression", label: "Expression", multi: false, order: 6, description: "Facial expression" },
  { key: "pose", label: "Pose", multi: false, order: 7, description: "Body pose or action" },
  { key: "clothing", label: "Clothing", multi: true, order: 8, description: "Outfit and garments" },
  { key: "accessories", label: "Accessories", multi: true, order: 9, description: "Jewelry, props, items" },
  { key: "location", label: "Location", multi: false, order: 10, description: "Scene location" },
  { key: "environment", label: "Environment", multi: true, order: 11, description: "Surrounding details" },
  { key: "weather", label: "Weather", multi: false, order: 12, description: "Weather conditions" },
  { key: "season", label: "Season", multi: false, order: 13, description: "Time of year" },
